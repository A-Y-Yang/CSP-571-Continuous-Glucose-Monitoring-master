...
ret %>% 
    ...
    theme(legend.position = "bottom")
```
# 5.2 Backtesting The LSTM On All 5 Samples
...
```{r, warning=FALSE}
predict_keras_lstm(split, epochs = 100)
```

# 5.2.2 Mapping The LSTM Prediction Function Over The 5 Samples
...
```{r}
#View(sample_predictions_lstm_tbl$predict[[1]]$value)
#View(sample_predictions_lstm_tbl$predict[[1]]$value[433:480])
#View(sample_predictions_lstm_tbl$predict[[1]]$value[481:524])
#length(sample_predictions_lstm_tbl$predict[[1]]$value[481:528])
```
