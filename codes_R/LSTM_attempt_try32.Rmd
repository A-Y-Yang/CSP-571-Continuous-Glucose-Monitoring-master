...
rolling_origin_resamples %>%
    plot_sampling_plan(expand_y_axis = T, ncol = 4, alpha = 1, size = 1, base_size = 10, 
                       title = "Plots of Test/Train Split")
```
...
#5.1 Single LSTM
```{r}
split    <- rolling_origin_resamples$splits[[2]]
split_id <- rolling_origin_resamples$id[[2]]
```
...
plot_prediction <- function(data, id, alpha = 1, size = 2, base_size = 16) {
